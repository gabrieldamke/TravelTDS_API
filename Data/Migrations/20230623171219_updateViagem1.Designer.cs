...
namespace Data.Migrations
{
    ...
    [Migration("20230623171219_updateViagem1")]
    partial class updateViagem1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.AtracaoTuristica", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Local", "Local")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.AtracaoTuristica", "LocalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.ParteViagem", null)
                        .WithMany("atracoesVisitadas")
            ...
            modelBuilder.Entity("Domain.Entities.Hotel", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Local", "Local")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.Hotel", "LocalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Restaurante", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.ParteViagem", null)
                        .WithMany("restaurantesVisitados")
                        .HasForeignKey("ParteViagemId");
